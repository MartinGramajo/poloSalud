        ...
        <div>
          ...
          <div className="my-4">
            <h5 style={{ fontSize: "18px" }}>
              ...
              ● estiramientos activos y pasivos, <br />● técnicas circulatorias
              de estimulación o drenaje
            </h5>
            <h5>
              En cada sesión, se observará al caballo estático y en sus
              diferentes aires y luego se palpará cada articulación y estructura
              músculo esquelética, pasiva y activamente.
            </h5>
          </div>
          <div>
            ...
            <div className="my-4">
              ...
              <h5 style={{ fontSize: "18px" }}>
                ...
                ligamentos. También tiene un impacto positivo a nivel
